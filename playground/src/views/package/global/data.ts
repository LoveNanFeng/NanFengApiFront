...
export function useFormSchema(): VbenFormSchema[] {
  return [
    ...
    },
    {
      ...
      defaultValue: 30,
      fieldName: 'validDays',
      label: $t('system.package.validDays'),
      rules: 'required',
    },
    {
      component: 'InputNumber',
      ...
      label: $t('system.package.dailyLimit'),
      rules: 'required',
    },
    {
      component: 'InputNumber',
      ...
      defaultValue: 0,
      fieldName: 'qpsLimit',
      label: $t('system.package.qpsLimit'),
      rules: 'required',
    },
    {
      component: 'Switch',
...
export function useColumns<T = PackageApi.GlobalPackage>(
  ...
  return [
    ...
    },
    {
      field: 'validDays',
      formatter: ({ cellValue }) =>
        $t('system.package.validDaysText', [Number(cellValue ?? 0)]),
      title: $t('system.package.validDays'),
      width: 120,
    },
    {
      field: 'dailyLimit',
